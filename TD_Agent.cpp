...
void TD_Agent<State_T>::findAction2()
{
	...
	Idee(bei tactactoe auch so gelöst) : Wenn die schlange gecrasht ist wird anstatt snake_event_pair.first->score() = 0.1, eine funktion aufgerufen die nur den state anpasst. 
	*/
	if (reward == 0.1)
	{
